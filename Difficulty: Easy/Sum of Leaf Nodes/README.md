<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-leaf-nodes/1?page=2&category=Tree&difficulty=Easy&sortBy=submissions">Sum of Leaf Nodes</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a binary tree, find the sum of values of all the leaf nodes.&nbsp;<br></span></p>
